...
parser.add_argument(
    "--poll-period", type=int, default=3000, help="Attribute polling period in ms"
)
...
def main(options):
    ...
    sys_url = "tango://{}:{}/".format(cm_dev.get_db_host(), cm_dev.get_db_port())
    cm_dev.Init()
